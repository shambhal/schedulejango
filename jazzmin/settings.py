...
DEFAULT_SETTINGS: Dict[str, Any] = {
    ...
    "hide_models": ['cod.cod','paypal.paypal','config.configmodel'],
    ...
    "custom_links":{"config": [
            {
                "name": "Site Settings",
                "url": "/admin/config/configmodel/showsave",
                "icon": "fas fa-cogs",
                "permissions": ["config.view_config"],
            }
        ]},
    ...
    "icons": {
       ...
       "category.category":"fas fa-list",
        "banners.banner":"fas fa-file-image",
          "doctor.book":"fas fa-book",
            "doctor.doctorspecial":"fas fa-calendar-days",
            "doctor.doctor":"fas fa-user-doctor",
              "orders.order":"fas fa-file-invoice",
              "information.information":"fas fa-sitemap",
            'payment.payment':"fas fa-file-invoice-dollar",
